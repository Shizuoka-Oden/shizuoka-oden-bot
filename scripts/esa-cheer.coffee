module.exports = (robot) ->
  cheer = [
    ...
    "ルージュはいつも一生懸命で、どんなことだってチャレンジして、何にだって全力でぶつかって、すっごく頑張ってるの！　だから私たちはいつだってそんなルージュを応援するよ。(Yes!プリキュア5GoGo!, プリキュアシリーズ, キュアドリーム)",
    ...
    "私、りんちゃん見てると思うんだ。何でも挑戦するりんちゃんのために、何かしてあげたいなぁ、応援したいなぁって。(Yes!プリキュア5GoGo!, プリキュアシリーズ, 夢原のぞみ)",
    ...
    "こんな時、あいつはこう言うのさ 迷った時はドカンとぶつかって行け!(バトルスピリッツ, 流れ星のキリガ, 最強銀河 究極ゼロ バトルスピリッツ)",
    ...
    "誰かを助けるという事は、誰かを助けないという事。正義の味方っていうのは、とんでもないエゴイストなんだ。(Fate/stay night, 衛宮切嗣)",
